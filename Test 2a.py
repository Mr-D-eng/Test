...
'''Написать программу, которая на основании запроса к погодному сервису выведет среднюю ощущаемую
вечернюю(eve) температуру в градусах Цельсия и минимальное давление за предстоящие 5 дней'''
